...
class ProjectGeneratorAgent(Agent):
    ...
    def chat(
        ...
        **kwargs: Any,
        ...
        prompt = get_prompt(AgentType.PROJECT_GENERATOR, ProjectGeneratorAgentPromptInput(message=message))
        self.system_prompt = prompt.system
        self.agent_prompt = prompt.client
        
        logger.info(f"Project generator agent prompt: {self.agent_prompt}")
        ...
        logger.info(f"Project generator response: {response}")
        return response