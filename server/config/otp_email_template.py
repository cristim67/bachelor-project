...
<html>
    <body>
        ...
        <h2> Click <a href="{API_URL}/auth/user/verify-otp?otp_code={otp_code}">here</a> to verify your email</h2>
...
def otp_email_template(otp_code: str):
    return otp_email_template_html.format(otp_code=otp_code, API_URL=API_URL, OTP_EXPIRATION_MINUTES=OTP_EXPIRATION_MINUTES)
