      ...
      <div className="w-full max-w-4xl">
        <div className="relative">
          <textarea
            ...
            className={`w-full px-4 py-3 pb-32 md:pb-20 rounded-lg resize-none overflow-y-auto ${
              theme === "light"
          ...
          />
          <div
            className={`absolute bottom-0 left-0 right-0 p-4 rounded-b-lg flex items-center justify-between gap-4 ${
              theme === "light"
            ...
            <div className="flex items-center gap-2">
              <div className="relative group">
                <button
                  ...
                  className={`inline-flex items-center gap-2 p-2 rounded-md ${
                    theme === "light"
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-black text-white text-xs rounded whitespace-nowrap opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity md:hidden">
                  {isPublic ? "Public" : "Private"}
                </div>
              </div>
      ...
      {enhancedPrompt && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          ...
          >
            ...
            >
              <h2 className="text-xl font-bold text-center">Compare Changes</h2>
            </div>
